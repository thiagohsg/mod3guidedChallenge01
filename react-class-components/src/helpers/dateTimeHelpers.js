// Função para preencher a esquerda do valor. Recebe o valor,
// número de caracteres, caracter que vai usar para preencher
...
// Função para formatar a data. Intl.DateTimeFormat
// não atende pois não exibe milissegundos.
